...
export function Hero() {
    return (
        <section className="relative w-full bg-[#f7ebe9] pt-12 pb-24 px-4 overflow-hidden ">
            ...
            <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-8">
                    <motion.div
                        ...
                        className="inline-block px-4 py-1.5 rounded-full bg-primary/20 border border-primary/20 text-primary font-semibold text-sm shadow-sm rotate-[-15deg]"
                    >
                        Never Stop Learning
                    </motion.div>
                ...
                >
                    ...
                    <div className="absolute top-50 right-10 w-1/2 h-3/4 bg-[#20B486] rounded-[40px] rotate-30 transform rotate-z-12 z-1"></div>
                    <div className="absolute top-30 right-10 w-1/2 h-3/4 bg-primary rounded-[40px] rotate-30 z-0"></div>
